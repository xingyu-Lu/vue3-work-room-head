<template>
	...
	<el-row v-for="(item, index) in column_list" :gutter="24" justify="flex-start" align="middle" style="line-height: 36px; margin-bottom: 20px;">
	...
	<el-row v-if="is_login && is_self" :gutter="24" justify="flex-start" align="middle" style="line-height: 36px; margin-bottom: 20px;">
		<el-col :sm="3">
