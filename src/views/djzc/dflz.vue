<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>党风廉政</el-breadcrumb-item>
	</el-breadcrumb>
				...
				<ul style="color: #409EFF; line-height: 38px;">
					<li>
						<div style="display: flex; justify-content: space-between;">
							<el-link style="font-size: 16px;" href="/dflz_detail" target="_blank" type="primary" :underline="false">
								宜宾市三医院：再部署再落实再推进 筑牢疫情防控安全线</el-link>
