<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>青年加油站</el-breadcrumb-item>
	</el-breadcrumb>
				...
				<ul style="color: #409EFF; line-height: 38px;">
					<li>
						<div style="display: flex; justify-content: space-between;">
							<el-link style="font-size: 16px;" href="/qnjyz_detail" target="_blank" type="primary" :underline="false">
								传承雷锋精神 关爱群众健康</el-link>
