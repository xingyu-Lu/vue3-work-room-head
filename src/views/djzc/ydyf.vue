<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>医德医风</el-breadcrumb-item>
	</el-breadcrumb>
				...
				<ul style="color: #409EFF; line-height: 38px;">
					<li>
						<div style="display: flex; justify-content: space-between;">
							<el-link style="font-size: 16px;" href="/ydyf_detail" target="_blank" type="primary" :underline="false">
								宜宾市第三人民医院开展“学党史办实事 敬老爱老送健康”活动</el-link>
