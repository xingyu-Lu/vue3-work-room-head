<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>党务教育</el-breadcrumb-item>
	</el-breadcrumb>
				...
				<ul style="color: #409EFF; line-height: 38px;">
					<li>
						<div style="display: flex; justify-content: space-between;">
							<el-link style="font-size: 16px;" href="/dyjy_detail" target="_blank" type="primary" :underline="false">
								党史学习教育 ㉛丨艰苦奋斗 奋发图强</el-link>
