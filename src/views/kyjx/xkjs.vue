<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>学科建设</el-breadcrumb-item>
	</el-breadcrumb>
		...
		<ul style="color: #409EFF; line-height: 38px;">
			<li v-for="(item, index) in res_data">
				<div style="display: flex; justify-content: space-between;">
					<el-link style="font-size: 16px;" :href="'/kydt_detail?id=' + item.id" target="_blank" type="primary" :underline="false">
						{{ item.title }}​</el-link>
...
<script>
	...
	export default {
		setup() {
			...
			const get_data = () => {
				axios.get('/api/head/scientifics/index', {
					params: {
