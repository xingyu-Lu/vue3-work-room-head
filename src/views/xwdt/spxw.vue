<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>视频新闻</el-breadcrumb-item>
	</el-breadcrumb>
		...
		<el-row :gutter="20" v-for="(item,index) in res_data" style="margin-bottom: 20px;"
			...
			<el-col :sm="24">
				<div style="display: flex; justify-content: space-between; cursor: pointer;"
					@click="go_detail('/spxw_detail?id=' + item.id)">
					...
					<!-- <div style="line-height: 50px; margin-left: 40px;"> -->
						<!-- <div> -->
							<el-link :underline="false" :href="'/spxw_detail?id=' + item.id" target="_blank">
								{{ item.title }}
							</el-link>
						<!-- </div> -->
						...
						<!-- </div> -->
						<!-- <div> -->
							<el-link :underline="false" :href="'/spxw_detail?id=' + item.id"
								target="_blank">
								{{ item.release_time }}
							</el-link>
						<!-- </div> -->
