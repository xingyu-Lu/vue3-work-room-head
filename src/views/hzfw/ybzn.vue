<template>
	...
	<el-breadcrumb separator="/" style="margin-bottom: 20px;">
		...
		<el-breadcrumb-item>医保指南</el-breadcrumb-item>
	</el-breadcrumb>
				...
				<ul style="color: #409EFF; line-height: 38px;">
					<li>
						<div style="display: flex; justify-content: space-between;">
							<el-link style="font-size: 16px;" href="/ybzn_detail" target="_blank" type="primary" :underline="false">
								聚焦┃深化医改，推进医院高质量发展</el-link>
